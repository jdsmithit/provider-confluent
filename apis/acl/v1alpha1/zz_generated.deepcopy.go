...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ACLBlock) DeepCopyInto(out *ACLBlock) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ACLBlock.
func (in *ACLBlock) DeepCopy() *ACLBlock {
	if in == nil {
		return nil
	}
	out := new(ACLBlock)
...
func (in *ACLObservation) DeepCopyInto(out *ACLObservation) {
	*out = *in
	if in.ACLObservationList != nil {
		in, out := &in.ACLObservationList, &out.ACLObservationList
		*out = make([]ACLObserveBlock, len(*in))
		copy(*out, *in)
	}
	if in.ACLResponseBlockList != nil {
		in, out := &in.ACLResponseBlockList, &out.ACLResponseBlockList
		*out = make([]ACLResponseBlock, len(*in))
		copy(*out, *in)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ACLObserveBlock) DeepCopyInto(out *ACLObserveBlock) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ACLObserveBlock.
func (in *ACLObserveBlock) DeepCopy() *ACLObserveBlock {
	if in == nil {
		return nil
	}
	out := new(ACLObserveBlock)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ACLParameters) DeepCopyInto(out *ACLParameters) {
	*out = *in
	if in.ACLBlockList != nil {
		in, out := &in.ACLBlockList, &out.ACLBlockList
		*out = make([]ACLBlock, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ACLResponseBlock) DeepCopyInto(out *ACLResponseBlock) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ACLResponseBlock.
func (in *ACLResponseBlock) DeepCopy() *ACLResponseBlock {
	if in == nil {
		return nil
	}
	out := new(ACLResponseBlock)
	in.DeepCopyInto(out)
	return out
}
