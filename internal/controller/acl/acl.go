...
func (c *external) Observe(ctx context.Context, mg resource.Managed) (managed.ExternalObservation, error) {
	...
	ccsa, err := client.ACLList(cr.Status.AtProvider.ServiceAccount, cr.Status.AtProvider.Environment, cr.Status.AtProvider.Cluster)
	...
	// Diff
	// current := cr.Spec.ForProvider.ACLBlockList
